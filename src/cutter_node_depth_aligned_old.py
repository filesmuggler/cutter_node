...
class CutterNode:
    def __init__(self):
        ...
        self.depth_aligned_pub = rospy.Publisher("/cutter_node_align_depth",Image, queue_size=1)
    ...
    def callback_image(self,data):
        ...
        self.depth_output =  thresh1 * self.depth 

        self.depth_output = np.float32(self.depth_output)

        #cv2.normalize(self.depth_output, self.depth_output, 0, 255, cv2.NORM_MINMAX)
